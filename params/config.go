...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		IstanbulBlock:           big.NewInt(900),
		MuirGlacierBlock:        big.NewInt(1000),
		BerlinBlock:             big.NewInt(1100),
		LondonBlock:             big.NewInt(1200),
		ArrowGlacierBlock:       big.NewInt(1300),
		GrayGlacierBlock:        big.NewInt(1400),
		EthPoWForkBlock:         big.NewInt(10000),
